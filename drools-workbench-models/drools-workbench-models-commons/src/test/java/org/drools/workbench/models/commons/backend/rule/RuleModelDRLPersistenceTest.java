...
public class RuleModelDRLPersistenceTest {
    ...
    @Test
    //https://issues.jboss.org/browse/RHBRMS-2752
    public void testInOperatorStringWithComma() {
        ...
        con.setFieldName("field1");
        con.setOperator("in");
        con.setValue("(\"value1a, value1b\", \"value2\")");
        con.setConstraintValueType(SingleFieldConstraint.TYPE_LITERAL);
        p.addConstraint(con);
        ...
        String expected = "rule \"in\" \n"
                + "dialect \"mvel\" \n"
                + "when \n"
                + "     Person(field1 in ( \"value1a, value1b\", \"value2\" ) ) \n"
                + " then \n"
                + "end";
